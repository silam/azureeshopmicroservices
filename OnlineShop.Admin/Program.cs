    ...
    class Program
    {
        ...
        private static async Task SeedProducts(CloudStorageAccount cloudStorageAccount, CloudTableClient tableClient)
        {
            try
            {
                ...
                var redWingShoesSKU = Guid.NewGuid().ToString();
                ...
                var redWingShoes = new ProductEntity(redWingShoesSKU, Guid.NewGuid().ToString())
                {
                    Category = "Red Wing Shoes",
                    Name = "Red Wing Shoes for Soldier",
                    Price = 330.00D
                };
                ...
                var redWingShoesInventory = new InventoryEntity("Red Wing Shoes", redWingShoesSKU)
                {
                    Quantity = 70
                }; 
                ...
                insertInventoryOperation = TableOperation.Insert(redWingShoesInventory);
                await inventoryTable.ExecuteAsync(insertInventoryOperation);
